...
def parse_opt():
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="wgmodel",
    ...
    parser.add_argument('--attr_data_dir', type=str, default='data/attr',
    ...
    parser.add_argument('--sg_data_dir', type=str, default='data/sg_data_final',
                        help='path to the scene graph data directory, containing numpy files about the '
                             'labels of object, attribute, and semantic relationships for each image')
    parser.add_argument('--rela_gnn_type', type=int, default=0,
                        help='rela gcn type')

    parser.add_argument('--n_attr_use', type=int, default=3,
                        help='if use attr info')

    parser.add_argument('--n_heads', type=int, default=2,
                        help='use attr num')
    parser.add_argument('--is_limited', type=bool, default=True,
                        help='use attr num')

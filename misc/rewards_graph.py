...
def get_self_critical_reward(model, core_args, sg_data, fc_feats, att_feats, weak_relas, att_masks, data,
                             gen_result,
                             opt):
    ...
    model.eval()
    with torch.no_grad():
        greedy_res, _ = model(sg_data, fc_feats, att_feats, weak_relas, att_masks,
